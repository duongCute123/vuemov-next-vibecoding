...
export const metadata: Metadata = {
  title: "Phim thuyết minh - NhungMov",
  description: "Xem phim thuyết minh tiếng Việt online miễn phí. Tuyển tập phim hay có thuyết minh chất lượng cao.",
  alternates: {
    canonical: "https://nhungmov.vercel.app/phim-thuyet-minh",
  },
};
...
export default async function PhimThuyetMinhPage({ searchParams }: PageProps) {
  ...
  const [categories, movies] = await Promise.all([
    ...
    getNewUpdatedMovies({ page, limit: 24, type_list: "phim-thuyet-minh" }).catch(() => ({ items: [] })),
  ]);
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Phim thuyết minh", "item": "https://nhungmov.vercel.app/phim-thuyet-minh" },
    ],
  };
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <main className="mx-auto max-w-7xl px-4 py-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">Phim Thuyết Minh</h1>
            <p className="text-sm text-zinc-400">Phim được thuyết minh tiếng Việt</p>
          </div>
        </div>
