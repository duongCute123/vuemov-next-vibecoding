...
export const metadata: Metadata = createPageMetadata(
  "Phim thuyết minh",
  "Xem phim thuyết minh tiếng Việt online miễn phí. Tuyển tập phim hay có thuyết minh chất lượng cao.",
  "/phim-thuyet-minh",
);
...
export default async function PhimThuyetMinhPage({ searchParams }: PageProps) {
  ...
  const [categories, movies] = await Promise.all([
    ...
    getNewUpdatedMovies({ page, limit: 24, type_list: "phim-thuyet-minh", sort_type: sortType }).catch(() => ({ items: [] })),
  ]);
