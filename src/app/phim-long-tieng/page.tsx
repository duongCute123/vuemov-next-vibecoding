...
export const metadata: Metadata = createPageMetadata(
  "Phim lồng tiếng",
  "Xem phim lồng tiếng online miễn phí. Phim hoạt hình, phim bộ, phim lẻ lồng tiếng Việt chất lượng cao.",
  "/phim-long-tieng",
);
...
export default async function PhimLongTiengPage({ searchParams }: PageProps) {
  ...
  const [categories, movies] = await Promise.all([
    ...
    getNewUpdatedMovies({ page, limit: 24, type_list: "phim-long-tieng", sort_type: sortType }).catch(() => ({ items: [] })),
  ]);
