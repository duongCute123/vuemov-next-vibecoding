...
export const metadata: Metadata = createPageMetadata(
  "Phim chiếu rạp",
  "Xem phim chiếu rạp online miễn phí. Phim điện ảnh mới nhất, phim bom tấn Hollywood và Châu Á vietsub chất lượng cao.",
  "/phim-chieu-rap",
);

type PageProps = { searchParams: Promise<{ page?: string; sort?: string; lang?: string }> };

export default async function PhimChieuRapPage({ searchParams }: PageProps) {
  ...
  const apiOpts: { page: number; limit: number; type_list: string; sort_type: "asc" | "desc"; sort_lang?: string } = { page, limit: 24, type_list: "phim-chieu-rap", sort_type: sortType };
      ...
      <main className="mx-auto max-w-7xl px-4 py-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-400">Những bộ phim đang hoặc đã chiếu tại rạp</p>
          </div>
        </div>
